#----------------------------------------------------------------
### Práctica de mapas y dashboard  | Semana 20-10
#----------------------------------------------------------------

## Fecha límite de entrega: Domingo 26 de octubre 23:59hs


## Para esta práctica, continúen trabajando con la base de datos que eligieron y exploraron en las prácticas anteriores. 

# Consigna 1. Elaborar dos mapas utilizando datos de manera libre:

## el primero debe ser un mapa de puntos
